...
export default async function TermsOfServicePage({ params }: PageProps) {
  ...
  return (
    <div className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-start">
      <AnimatedSection y={20}>
        <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white mb-8 border-b border-slate-200 dark:border-slate-800 pb-4">
          {isFa ? 'شرایط استفاده از خدمات آرتین تیم' : 'Artin Team Terms of Service'}
        </h1>
        
        <div className="space-y-6 text-sm text-slate-650 dark:text-slate-300 leading-relaxed">
          {isFa ? (
            <>
              <p>
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">۱. مالکیت معنوی</h2>
              <p>
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">۲. توافق‌نامه توسعه نرم‌افزار</h2>
              <p>
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">۳. تغییرات در شرایط</h2>
              <p>
            ...
            <>
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">1. Intellectual Property</h2>
              <p>
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">2. Development Agreements</h2>
              <p>
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">3. Modifications</h2>
              <p>

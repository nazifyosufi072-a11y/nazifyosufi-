        ...
        <div className="space-y-6 text-sm text-slate-650 dark:text-slate-300 leading-relaxed">
          {isFa ? (
            <>
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">۱. اطلاعاتی که جمع‌آوری می‌کنیم</h2>
              <p>
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">۲. استفاده از اطلاعات</h2>
              <p>
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">۳. حفاظت از اطلاعات</h2>
              <p>
            ...
            <>
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">2. Use of Information</h2>
              <p>
              ...
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">3. Information Protection</h2>
              <p>
